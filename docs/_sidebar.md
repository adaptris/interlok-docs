...
- [Overview](/pages/overview/)
 - [What is an adapter](/pages/overview/adapter-what-is-it.md)
...
- [Integration Guides](/pages/cookbook/)
 ...
 - [Email (POP3/IMAP/SMTP)](/pages/cookbook/cookbook-email.md)
 ...
 - [Data Transformation](/pages/cookbook/cookbook-transform.md)
    ...
    - [JSON Manipulation](/pages/cookbook/cookbook-json-transform.md)
    - [CSV to XML](/pages/cookbook/cookbook-csv-transform.md)
    - [EDI Transformation](/pages/cookbook/cookbook-edi-transform.md)
- [Advanced](/pages/advanced/)
 - [Logic blocks in configuration](/pages/advanced/advanced-conditional.md)     
 - [Clustering Instances](/pages/advanced/advanced-cluster.md)
 ...
 - [Failover Clustering](/pages/advanced/advanced-failover.md)
